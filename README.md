...
2. **Supabase → Authentication → Providers → Google**: enable, paste the Google OAuth client ID and secret.
3. **Supabase → Authentication → URL Configuration**: Site URL = your Vercel URL; add `https://YOUR-SITE.vercel.app/auth/callback` to Redirect URLs.
